export default [
  ...
  { name: 'Stop', code: 'C_STOP', title: 'Stop' },
  ...
  { width: 250 },
  { name: 'Mouse 1', code: '&mp 1', title: 'Mouse Button 1' },
  { name: 'Mouse 2', code: '&mp 2', title: 'Mouse Button 2' },
  ...
  { width: 250 },
  { name: 'Mouse Wheel Up', code: '&mw WHEEL_UP 1', title: 'Mouse Wheel Up' },
  {
    name: 'Mouse Wheel Down',
    code: '&mw WHEEL_DOWN 1',
